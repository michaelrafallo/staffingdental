                            ...
                            <div class="col-md-12 profile-info">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10 col-sm-12 col-xs-12">
                                        ...
                                        <h4><span class="text-muted">Job posted by</span> : {{ ucwords(@$info->user->find($info->post_author)->firstname) }} 
                                            <span class="blurry rtip">{{ str_mask(@$info->user->find($info->post_author)->lastname, 0) }}</span></h4>
                                    ...
                                    <div class="margin-top-20 margin-bottom-20">
                                        ...
                                        @if( $info->post_status == 'approved' )
                                            ...
                                            <a class="btn uppercase" data-toggle="modal" href="#basic"><i class="icon-bubbles"></i>  Send Message</a>
                       

                                        @endif                        


                                        <a data-toggle="modal" href="#basic" class="btn uppercase"><i class="fa fa-user"></i> View Profile</a>

                                        <a href="{{ URL::route('find.jobs.index') }}" class="btn  uppercase mt-xs-10"><i class="fa fa-search"></i> Browse more Jobs</a>            

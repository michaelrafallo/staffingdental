                                                                        ...
                                                                        <tbody>
                                                                           <tr>
                                                                              <td class="kmImageContent" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;padding:0;padding-top:20px;padding-bottom:0;padding-left:9px;padding-right:9px;text-align: center;">
                                                                                 <img src="{{ asset(App\Setting::get_setting('logo')) }}" style="width:200px;">                                                                                
                                                                              </td>
                                                                           </tr>
                                                                        </tbody>
                                                                     </table>
                                                                           ...
                                                                           <tr>
                                                                              <td class="kmTextContent" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;color:#505050;font-family:Helvetica, Arial;font-size:14px;line-height:150%;text-align:left;padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
                                                                                 <div class="kmParagraph" style="padding-bottom:9px">
                                                                                    ...
                                                                                    <p>We see you forgot your password.  Don’t worry—it’s easy to do!</p> 
                                                                                    <p>To reset your password, just click on this button:</p>
                                                                                 </div>
                                                                              </td>
                                                                           </tr>
                                                                        </tbody>
                                                                                                ...
                                                                                                <tbody>
                                                                                                   <tr>
                                                                                                      <td class="kmVerticalButtonContentOuter" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;">
                                                                                                         <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmVerticalButtonContent" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;border-radius:10px;    background-color: #4d90fe;border-bottom-color: #4c4c4c;border-bottom-width:2px;border-bottom-style:solid;border-collapse:separate;">
                                                                                                            <tbody>
                                                                                                               <tr>
                                                                  ...
                                                                  <td class="kmTextBlockInner" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;">
                                                                     <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTextContentContainer" width="100%" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0">
                                                                        <tbody>
                                                                           <tr>
                                                                              <td class="kmTextContent" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;color:#505050;font-family:Helvetica, Arial;font-size:14px;line-height:150%;text-align:left;padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
                                                                                 <p style="margin:0;padding-bottom:1em;font-family: arial, sans-serif; line-height: normal;">If the button doesn't work, please try copying and pasting this link into your browser:</p>

                                                                                 <p style="margin:0;padding-bottom:1em;font-family: arial, sans-serif; line-height: normal;"><a href="{{ $token_url }}" style="word-wrap:break-word;color:#ED4B83;font-weight:normal;text-decoration:none;color: rgb(17, 85, 204);" target="_blank">{{ $token_url }}</a></p>

                                                                                 <p style="margin:0;padding-bottom:1em;font-family: arial, sans-serif; line-height: normal;">If you didn't request to reset your password, simply disregard this message.</p>

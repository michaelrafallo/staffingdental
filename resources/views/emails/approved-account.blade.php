...
<p>Congratulations, your Staffing Dental account is approved!</p> 

<p>Welcome to our team.  We look forward to working with you, and using your talent to benefit our employers’ patients.</p>

<p>All best,</p>

<p><b>{{ $site_name }}</b></p>

<p><a href="{{ URL::route('auth.login') }}">Login Now</a></p>

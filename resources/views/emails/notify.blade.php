...
<p style="margin:0;padding-bottom:1em;font-family: arial, sans-serif; line-height: normal;">
@if($msg)
{!! $msg !!}
@else
<p>You have a notification in your account</p>
@endif
</p>

please log into your account for further details

<p><a href="{{ $url }}">Login Now</a></p>

...
<p>Your profile on {{ $site_title }} is currently incomplete.</p>

<p>Please set aside a minute to complete your profile.</p>
...
<ol>
    ...
    <li>
        Upload Valid Government Issued Picture ID
    </li>
    <?php $complete += 1; ?>
    @endif
...
<p><a href="{{ URL::route(@$user->group.'.dashboard') }}" style="border: 1px solid;
    display: inline-block;
    padding: 10px 20px;
    text-decoration: none;
    background: #337ab7;
    color: #fff;">Edit Profile</a></p>

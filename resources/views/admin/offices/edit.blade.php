...
<h1 class="page-title">Office Information <small>View Request</small></h1>
...
<form class="form-horizontal form-submit" method="post" action="" enctype="multipart/form-data">
    <div class="form-body">
        ...
        <div class="mt-repeater">
                ...
                @if( $offices = json_decode($info->post_content, true) ) 

                @foreach($offices as $office)
                <input type="hidden" name="amount[]" value="{{ @$office['amount'] }}">
                ...
                <div data-repeater-item class="mt-repeater-item">
                    ...
                    <div class="form-group  margin-top-40">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                {!! Form::select('state', ['' => 'Select State'] + states(),  '', ["class" => "form-control select2"]) !!}
                                <!-- START error message -->
                                {!! $errors->first('state','<span class="help-block text-danger">:message</span>') !!}
                                <!-- END error message -->
                            </div>
                ...
                <div class="form-actions">                
                    ...
                    <a href="{{ URL::route('admin.offices.view', $info->id) }}" class="btn">Cancel</a>
                </div>      

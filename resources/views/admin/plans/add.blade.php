...
<div class="col-md-8 col-sm-8 col-centered margin-top-40">
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject uppercase">Add Plan</span>
            </div>
        </div>
            ...
            <form class="form-horizontal" role="form" method="post">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="title" placeholder="Plan Title" value="{{ Input::old('title') }}">
                            <!-- START error message -->
                            ...
                            <div class="mt-repeater">
                                <div data-repeater-list="description">
                                    @if( Input::old('description') )
                                        @foreach( Input::old('description') as $desc )
                        ...
                        <div class="col-md-8 col-md-offset-3">
                            ...
                            <div class="mt-repeater">
                                <div data-repeater-list="total">
                                    ...
                                    @if( Input::old('total') )
                                        @foreach( Input::old('total') as $total )
                                        <div data-repeater-item class="mt-repeater-item">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-icon">
                                                        ...
                                                        <input type="text" name="amount_per_day" class="form-control day day-amount" value="{{ $total['amount_per_day'] }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <label class="small">Number of Days</label>
                                                    <div class="input-group">
                                                        <input type="text"name="number_of_day" class="form-control day day-number" value="{{ $total['number_of_day'] }}"> 
                                                        <span class="input-group-btn">
                                                        <a href="javascript:;" data-repeater-delete class="btn btn-danger mt-repeater-delete">
                                                        <i class="fa fa-close"></i>
                                                        </a>
                                                ...
                                                <input type="hidden" name="amount" class="amount" value="{{ $total['amount'] }}">
                                                <div class="col-md-4"><h3 class="text-right">$<span class="period-total">{{ $total['amount'] }}</span></h3></div>
                                            </div>
                                        </div>
                                        @endforeach
                                    @else
                ...
                <div class="form-actions right">
                    <div class="row">
                        <div class="col-md-offset-2 col-md-9">
                            ...
                            <button type="submit" class="btn btn-primary uppercase btn-circle"><i class="fa fa-check"></i> Save Plan</button>
                        </div>
                    </div>
                </div>

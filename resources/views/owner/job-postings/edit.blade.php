    ...
    <div class="portlet light bordered">
        ...
        <form class="form-horizontal form-submit" role="form" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    {!! Form::select('office', ['' => 'Select Office'] + $offices, Input::old('office', $info->office), ["class" => "form-control select2"]) !!}
                    <!-- START error message -->
            ...
            <div class="form-group schedule full_time part_time" style="{{  in_array(Input::old('job_type', @$info->job_type), ['part_time', 'full_time']) ? '' : 'display:none;' }}">
                ...
                <table class="table table-hover table-striped table-condensed">
                    ...
                    $availability = json_decode($info->working_hours, true);
            ...
            <div class="form-group schedule temporary" style="{{  Input::old('job_type', @$info->job_type) == 'temporary' ? '' : 'display:none;' }}">
                ...
                <div class="col-md-8">
                    <div class="sched-repeater">
                        <div data-repeater-list="schedule">
                            ...
                            @if($info->schedule)
                            @foreach( json_decode($info->schedule, true) as $sched)
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group">
                        <input type="text" name="salary_rate" class="form-control numeric" placeholder="Salary Rate" value="{{ Input::old('salary_rate', @$info->salary_rate) }}">
                        <span class="input-group-addon salary-prefix">{{ salary_prefix(@$info->salary_type) }}</span>
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input type="text" name="number_of_position" class="form-control numeric" placeholder="Number of available position" value="{{ Input::old('number_of_position', @$info->number_of_position) }}">
                    <!-- START error message -->
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    {!! Form::select('job_status', job_status(), Input::old('job_status', @$info->job_status), ["class" => "form-control"]) !!}
                </div>
            </div>

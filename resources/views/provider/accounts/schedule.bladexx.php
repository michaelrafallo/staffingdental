...
<div class="row margin-top-20">
    ...
    <div class="portlet-body form">
        <h1 class="page-title"><i class="icon icon-calendar"></i> Schedule</h1>

        <p class="well">NOTE: Select "ON" next to any days and times when you are regularly available to work with offices through Staffing Dental.</p>
        <p class="well">Offices can book your services in real-time during any time slots you select below. They will expect you to honor this schedule and to keep it updated. If your schedule changes, be sure update this page.</p>
...
<?php endforeach; ?>
    ...
    <div class="col-md-5">
        ...
        <h1 class="page-title"><i class="icon icon-pin"></i> Unavailable Schedule</h1>
        <p class="well">Use this to designate specific times as unavailable. This is useful if you are going on vacation or are booked for a work assignment not through the platform.</p>
    </div>
